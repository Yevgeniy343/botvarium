    ...
    <Wrapper>
      ...
      >
        ...
        >
          ...
          <div className="about">
            <p>
              Все больше набирают популярность мессенджеры, потому что они
              позволяют обмениваться визуальной информацией в реальном времени.
              Мы занимаемся разработкой мессенджеров, которые можно использовать
