    ...
    <Wrapper>
      ...
      >
        ...
        >
          ...
          <div className="about">
            <p>
              Продуктивность сотрудников может быть увеличена за счет
              корпоративного пространства, где сотрудники имеют доступ только к
              нужной им для работы информации а доступ к внешней среде может
              быть ограничен.
            </p>
          </div>
        </div>
