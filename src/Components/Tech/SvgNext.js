...
function Icon() {
  return (
    <>
      <Wrapper id="next" data-tooltip-content="Nextjs">
        <Tooltip anchorId="next" className="tooltip" />
        <motion.svg
